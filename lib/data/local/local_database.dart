...
import '../models/address_model/adress_model.dart';
...
class LocalDatabase {
  ...
  Future<Database> get database async {
    if (_database != null) {
      ...
      _database = await _initDB("usersss.db");
      return _database!;
    }
  }
  ...
  Future _createDB(Database db, int version) async {
    ...
    ${AddressModelFields.padez} $textType,
    ${AddressModelFields.etaj} $textType,
    ${AddressModelFields.kvartira} $textType,
    ${AddressModelFields.manzil} $textType
    )
    ''');
